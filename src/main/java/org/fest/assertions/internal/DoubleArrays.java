...
public class DoubleArrays {
   ...
   */
  public void assertNullOrEmpty(Description description, double[] actual) {
   ...
   */
  public void assertEmpty(Description description, double[] actual) {
   ...
   */
  public void assertNotEmpty(Description description, double[] actual) {
   ...
   */
  public void assertHasSize(Description description, double[] actual, int expectedSize) {
   ...
   */
  public void assertContains(Description description, double[] actual, double[] values) {
   ...
   */
  public void assertContains(Description description, double[] actual, double value, Index index) {
   ...
   */
  public void assertDoesNotContain(Description description, double[] actual, double[] values) {
   ...
   */
  public void assertDoesNotContain(Description description, double[] actual, double value, Index index) {
   ...
   */
  public void assertContainsOnly(Description description, double[] actual, double[] values) {
   ...
   */
  public void assertContainsSequence(Description description, double[] actual, double[] sequence) {
   ...
   */
  public void assertDoesNotHaveDuplicates(Description description, double[] actual) {
   ...
   * Similar to <code>{@link #assertContainsSequence(Description, double[], double[])}</code>, but it also verifies that
   ...
   */
  public void assertStartsWith(Description description, double[] actual, double[] sequence) {
   ...
   */
  public void assertEndsWith(Description description, double[] actual, double[] sequence) {
