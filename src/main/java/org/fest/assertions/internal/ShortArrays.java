...
public class ShortArrays {
   ...
   */
  public void assertNullOrEmpty(Description description, short[] actual) {
   ...
   */
  public void assertEmpty(Description description, short[] actual) {
   ...
   */
  public void assertNotEmpty(Description description, short[] actual) {
   ...
   */
  public void assertHasSize(Description description, short[] actual, int expectedSize) {
   ...
   */
  public void assertContains(Description description, short[] actual, short[] values) {
   ...
   */
  public void assertContains(Description description, short[] actual, short value, Index index) {
   ...
   */
  public void assertDoesNotContain(Description description, short[] actual, short value, Index index) {
   ...
   */
  public void assertContainsOnly(Description description, short[] actual, short[] values) {
   ...
   */
  public void assertContainsSequence(Description description, short[] actual, short[] sequence) {
   ...
   */
  public void assertDoesNotContain(Description description, short[] actual, short[] values) {
   ...
   */
  public void assertDoesNotHaveDuplicates(Description description, short[] actual) {
   ...
   * Similar to <code>{@link #assertContainsSequence(Description, short[], short[])}</code>, but it also verifies that
   ...
   */
  public void assertStartsWith(Description description, short[] actual, short[] sequence) {
   ...
   */
  public void assertEndsWith(Description description, short[] actual, short[] sequence) {
    arrays.assertEndsWith(description, actual, sequence);
  }

  /**
   * Verifies that the actual is sorted into ascending order according to the natural ordering of its elements. Empty
   * arrays are considered sorted.
   *
   * @param description contains the information about the assertion.
   * @param actual the given array.
   * @throws AssertionError if the {@code actual} is {@code null}.
   */
  public void assertIsSorted(Description description, short[] actual) {
    if (actual == null) {
