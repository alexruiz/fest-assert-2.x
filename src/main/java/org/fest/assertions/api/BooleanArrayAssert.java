...
public class BooleanArrayAssert extends AbstractAssert<BooleanArrayAssert, boolean[]> implements
    EnumerableAssert<BooleanArrayAssert> {
  ...
  protected BooleanArrayAssert(boolean[] actual, Description description) {
    super(actual, BooleanArrayAssert.class, description);
  }

  /** {@inheritDoc} */
  @Override
  public BooleanArrayAssert isNullOrEmpty() {
