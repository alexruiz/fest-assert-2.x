 ...
 * For example:
 * <p>
 * List&lt;Employee&gt; newEmployees = employees.hired(TODAY); {@link Assertions#assertThat(Collection) assertThat}
 * (newEmployees).{@link CollectionAssert#hasSize(int) hasSize}(6);
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 * @author David DIDIER
...
public class Assertions {
  ...
  /**
   * Creates a new instance of <code>{@link SetAssert}</code>.
   *
   * @param actual the actual value.
   * @return the created assertion object.
   */
  public static <T> SetAssert assertThat(Set<T> actual) {
