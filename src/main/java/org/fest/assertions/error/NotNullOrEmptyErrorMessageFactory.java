 ...
 * @author Yvonne Wang
 */
public class NotNullOrEmptyErrorMessageFactory extends BasicErrorMessageFactory {
  /**
   * Creates a new instance of {@link NotNullOrEmptyErrorMessageFactory}.
   *
  ...
  public static ErrorMessageFactory shouldBeNullOrEmpty(Object actual) {
    return new NotNullOrEmptyErrorMessageFactory(actual);
  }

  private NotNullOrEmptyErrorMessageFactory(Object actual) {
