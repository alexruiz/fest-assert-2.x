...
public class ElementsShouldBeAtMost extends BasicErrorMessageFactory {
   ...
   */
  public static ErrorMessageFactory elementsShouldBeAtMost(Object actual, int times, Matcher<?> condition) {
    return new ElementsShouldBeAtMost(actual, times, condition);
  }

  private ElementsShouldBeAtMost(Object actual, int times, Matcher<?> condition) {
