...
public class ElementsShouldNotHave extends BasicErrorMessageFactory {
   ...
   */
  public static ErrorMessageFactory elementsShouldNotHave(Object actual, Object notSatisfies, Matcher<?> condition) {
    return new ElementsShouldNotHave(actual, notSatisfies, condition);
  }

  private ElementsShouldNotHave(Object actual, Object notSatisfies, Matcher<?> condition) {
    super("expecting elements:\n<%s>\n of \n<%s>\n not to have <%s>", notSatisfies, actual, condition);
  }
}
