...
public class ElementsShouldNotBeExactly extends BasicErrorMessageFactory {
   ...
   */
  public static <E> ErrorMessageFactory elementsShouldNotBeExactly(Object actual, int times, Matcher<?> condition) {
    return new ElementsShouldNotBeExactly(actual, times, condition);
  }

  private ElementsShouldNotBeExactly(Object actual, int times, Matcher<?> condition) {
