...
/**
 * Tests for {@link Matchers#assertIsNot(Description, Object, Matcher)}.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class Matchers_assertIsNot_Test {
  @Rule
  ...
  public void should_throw_error_if_Matcher_is_null() {
    ...
    matchers.assertIsNot(mock(Description.class), "Yoda", null);
  }

  @Test
  public void should_pass_if_Matcher_is_not_met() {
    matcher.shouldMatch(false);
    matchers.assertIsNot(mock(Description.class), "Yoda", matcher);
  }
