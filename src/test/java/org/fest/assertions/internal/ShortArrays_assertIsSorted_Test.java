 ...
 * @author Yvonne Wang
 */
public class ShortArrays_assertIsSorted_Test {
  ...
  private short[] actual = { 1, 2, 3, 4, 5, 6 };
  ...
  public void should_pass_if_actual_is_empty() {
    arrays.assertIsSorted(description, new short[0]);
  }

  @Test
  public void should_pass_if_actual_is_sorted_with_same_elements() {
    actual = new short[] { 1, 2, 3, 4, 5, 5, 6, 6 };
    arrays.assertIsSorted(description, actual);
  }
  ...
  public void should_fail_if_actual_is_not_sorted_even_with_same_elements() {
    actual = new short[] { 1, 3, 3, 2, 6, 5, 6 };
    try {
      arrays.assertIsSorted(description, actual);
    } catch (AssertionError e) {
