...
public class Floats_assertIsNotNaN_Test {
  ...
  public void should_fail_if_actual_is_null() {
    ...
    floats.assertIsNotNaN(description, null);
  }

  @Test
  public void should_fail_if_actual_is_NaN() {
    try {
      floats.assertIsNotNaN(description, Float.NaN);
    } catch (AssertionError e) {
      verify(failures).failure(description, ShouldNotBeEqual.shouldNotBeEqual(Float.NaN, Float.NaN));
      return;
    }
  ...
  public void should_pass_if_actual_is_not_NaN() {
    floats.assertIsNotNaN(description, new Float(6.0));
  }
}
