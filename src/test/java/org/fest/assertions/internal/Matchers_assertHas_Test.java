...
/**
 * Tests for {@link Matchers#assertHas(Description, Object, Matcher)}.
 *
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class Matchers_assertHas_Test {
  @Rule
  ...
  @Test public void should_throw_error_if_Matcher_is_null() {
    thrown.expect(NullPointerException.class);
    matchers.assertHas(mock(Description.class), "Yoda", null);
  }

  @Test public void should_pass_if_Matcher_is_met() {
