...
public class ShortArrays_assertContains_Test extends ShortArraysBaseTest {
  ...
  public void should_pass_if_actual_contains_given_values() {
    arrays.assertContains(someInfo(), actual, newArray(6));
  }

  @Test
  public void should_pass_if_actual_contains_given_values_in_different_order() {
    arrays.assertContains(someInfo(), actual, newArray(8, 10));
  }

  @Test
  public void should_pass_if_actual_contains_all_given_values() {
    arrays.assertContains(someInfo(), actual, newArray(6, 8, 10));
  }

  @Test
  public void should_pass_if_actual_contains_given_values_more_than_once() {
    actual = newArray(6, 8, 10, 10, 8);
    arrays.assertContains(someInfo(), actual, newArray(8));
  }

  @Test
  public void should_pass_if_actual_contains_given_values_even_if_duplicated() {
    arrays.assertContains(someInfo(), actual, newArray(6, 6));
  }
  ...
  public void should_fail_if_actual_is_null() {
    ...
    arrays.assertContains(someInfo(), null, newArray(8));
  }
  ...
  public void should_fail_if_actual_is_null_whatever_custom_comparison_strategy_is() {
    thrown.expectAssertionError(actualIsNull());
    arraysWithCustomComparisonStrategy.assertContains(someInfo(), null, newArray(8));
  }
