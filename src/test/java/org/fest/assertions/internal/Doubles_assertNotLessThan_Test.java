 ...
 * @author Yvonne Wang
 */
public class Doubles_assertNotLessThan_Test {
  ...
  public void should_fail_if_actual_is_less_than_other() {
    try {
      doubles.assertNotLessThan(description, 6d, 8d);
    } catch (AssertionError e) {
      verify(failures).failure(description, shouldNotBeLessThan(6d, 8d));
      return;
    }
  ...
  public void should_pass_if_actual_is_greater_than_other() {
    doubles.assertNotLessThan(description, 8d, 6d);
  }

  @Test
  public void should_pass_if_actual_is_equal_to_other() {
    doubles.assertNotLessThan(description, 6d, 6d);
  }
}
