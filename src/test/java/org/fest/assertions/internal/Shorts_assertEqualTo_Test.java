 ...
 *
 */
public class Shorts_assertEqualTo_Test {
  ...
  public void should_fail_is_actual_is_null() {
    ...
    shorts.assertEqualTo(description, null, expected);
  }
  ...
  public void should_fail_if_actual_not_equal_to_expected() {
    ...
    try {
      ...
      verify(failures).failure(description, shouldBeEqual(actual, expected));
      return;
    }
    throw TestFailures.expectedAssertionErrorNotThrown();
  }
