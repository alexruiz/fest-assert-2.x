...
public class Floats_assertLessThan_Test {
  ...
  public void should_fail_if_actual_is_null() {
    ...
    floats.assertLessThan(description, null, 8f);
  }

  @Test
  public void should_fail_if_actual_is_greater_than_other() {
    try {
      floats.assertLessThan(description, 8f, 6f);
    } catch (AssertionError e) {
      verify(failures).failure(description, shouldBeLessThan(8f, 6f));
      return;
    }
  ...
  public void should_fail_if_actual_is_equal_to_other() {
    try {
      floats.assertLessThan(description, 6f, 6f);
    } catch (AssertionError e) {
      verify(failures).failure(description, shouldBeLessThan(6f, 6f));
      return;
    }
    expectedAssertionErrorNotThrown();
  }
  ...
  public void should_pass_if_actual_is_less_than_other() {
    floats.assertLessThan(description, 6f, 8f);
  }
}
