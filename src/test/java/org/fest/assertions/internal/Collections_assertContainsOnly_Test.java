...
public class Collections_assertContainsOnly_Test {
  ...
  public void should_pass_if_actual_contains_given_values_only_in_different_order() {
    collections.assertContainsOnly(description, actual, array("Leia", "Yoda", "Luke"));
  }
  ...
  public void should_pass_if_actual_contains_only_given_values_with_xtuplicated() {
    collections.assertContainsOnly(description, actual, array("Luke", "Luke", "Luke", "Yoda", "Leia"));
  }

  @Test
  public void should_throw_error_if_array_of_values_to_look_for_is_empty() {
    thrown.expect(IllegalArgumentException.class, valuesToLookForIsEmpty());
    collections.assertContainsOnly(description, actual, new Object[] {});
  }

  @Test
  public void should_throw_error_if_array_of_values_to_look_for_is_null() {
    thrown.expect(NullPointerException.class, valuesToLookForIsNull());
    collections.assertContainsOnly(description, emptyList(), null);
  }

  @Test
  public void should_fail_if_actual_is_null() {
    thrown.expect(AssertionError.class, actualIsNull());
    collections.assertContainsOnly(description, null, array("Yoda"));
  }
