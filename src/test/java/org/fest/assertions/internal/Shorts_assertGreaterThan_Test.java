...
public class Shorts_assertGreaterThan_Test {
  ...
  public void should_fail_is_actual_is_null() {
    ...
    shorts.assertGreaterThan(description, null, (short) 2);
  }
  ...
  public void should_fail_if_actual_is_equal_to_expected() {
    short actual = 8;
    try {
      shorts.assertGreaterThan(description, actual, actual);
    } catch (AssertionError e) {
      verify(failures).failure(description, ShouldBeGreaterThan.shouldBeGreaterThan(actual, actual));
      return;
    }
    throw expectedAssertionErrorNotThrown();
  }
