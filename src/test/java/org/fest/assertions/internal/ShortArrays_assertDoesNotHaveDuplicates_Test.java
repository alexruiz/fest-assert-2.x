 ...
 */
public class ShortArrays_assertDoesNotHaveDuplicates_Test extends AbstractTest_for_ShortArrays {
  ...
  public void should_fail_if_actual_contains_duplicates_according_to_custom_comparison_strategy() {
    ...
    try {
      ...
      verify(failures).failure(info,
          shouldNotHaveDuplicates(actual, set((short) 6, (short) 8), absValueComparisonStrategy));
      return;
    }
    failBecauseExpectedAssertionErrorWasNotThrown();
  }
