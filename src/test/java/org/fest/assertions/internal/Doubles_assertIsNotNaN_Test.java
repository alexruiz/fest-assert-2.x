...
public class Doubles_assertIsNotNaN_Test {
  ...
  public void should_fail_if_actual_is_null() {
    ...
    doubles.assertIsNotNaN(description, null);
  }

  @Test
  public void should_fail_if_actual_is_NaN() {
    try {
      doubles.assertIsNotNaN(description, Double.NaN);
    } catch (AssertionError e) {
      verify(failures).failure(description, ShouldNotBeEqual.shouldNotBeEqual(Double.NaN, Double.NaN));
      return;
    }
  ...
  public void should_pass_if_actual_is_not_NaN() {
    doubles.assertIsNotNaN(description, new Double(6.0));
  }
}
