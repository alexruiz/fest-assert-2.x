...
public class Floats_assertNotEqual_Test {
  ...
  public void should_fail_if_actual_is_null() {
    ...
    floats.assertNotEqual(description, null, 8f);
  }

  @Test
  public void should_fail_if_actual_is_equal_to_expected() {
    try {
      floats.assertNotEqual(description, 8f, 8f);
    } catch (AssertionError e) {
      verify(failures).failure(description, ShouldNotBeEqual.shouldNotBeEqual(8f, 8f));
      return;
    }
  ...
  public void should_pass_if_actual_is_not_equal_to_expected() {
    floats.assertNotEqual(description, 8f, 6f);
  }
}
