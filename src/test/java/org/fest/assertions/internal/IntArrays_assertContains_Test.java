 ...
 */
public class IntArrays_assertContains_Test extends AbstractTest_for_IntArrays {
  ...
  public void should_fail_if_actual_does_not_contain_values_according_to_custom_comparison_strategy() {
    ...
    try {
      ...
      verify(failures).failure(info, shouldContain(actual, expected, set(9), absValueComparisonStrategy));
      return;
    }
    failBecauseExpectedAssertionErrorWasNotThrown();
  }
