 ...
 */
public class FloatArrays_assertDoesNotContain_Test extends AbstractTest_for_FloatArrays {
  ...
  public void should_fail_if_actual_contains_given_values_according_to_custom_comparison_strategy() {
    ...
    try {
      ...
      verify(failures).failure(info, shouldNotContain(actual, expected, set(6f, -8f), absValueComparisonStrategy));
      return;
    }
    failBecauseExpectedAssertionErrorWasNotThrown();
  }
