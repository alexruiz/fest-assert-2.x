...
public class Characters_assertUpperCase_Test {
  ...
  public void should_fail_if_actual_is_null() {
    ...
    characters.assertUpperCase(description, null);
  }

  @Test
  public void should_fail_if_actual_is_lowercase() {
    try {
      characters.assertUpperCase(description, 'a');
    } catch (AssertionError e) {
      verify(failures).failure(description, ShouldBeUpperCase.shouldBeUpperCase('a'));
      return;
    }
