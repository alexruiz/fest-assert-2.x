...
/**
 * Tests for {@link Strings#assertMatches(Description, String, String)}.
 *
 * @author Alex Ruiz
 */
public class Strings_assertMatches_String_Test {
  ...
  @Test
  public void should_pass_if_actual_matches_regular_expression() {
    strings.assertMatches(mock(Description.class), "Yoda", "Yod.*");
  }
  ...
  public void should_throw_error_if_regular_expression_is_null() {
    ...
    String regex = null;
    strings.assertMatches(mock(Description.class), "Yoda", regex);
  }

  @Test
  public void should_throw_error_if_syntax_of_regular_expression_is_invalid() {
    thrown.expect(PatternSyntaxException.class);
    strings.assertMatches(mock(Description.class), "Yoda", "*...");
  }
