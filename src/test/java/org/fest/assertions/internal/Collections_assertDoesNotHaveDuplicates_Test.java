...
/**
 * Tests for {@link Collections#assertDoesNotHaveDuplicates(Description, Collection)}.
 *
 * @author Yvonne Wang
 */
public class Collections_assertDoesNotHaveDuplicates_Test {
  ...
  public void should_pass_if_actual_is_empty() {
    collections.assertDoesNotHaveDuplicates(description, emptyList());
  }

  @Test
  public void should_fail_if_actual_is_null() {
    thrown.expect(AssertionError.class, actualIsNull());
    collections.assertDoesNotHaveDuplicates(description, null);
  }
