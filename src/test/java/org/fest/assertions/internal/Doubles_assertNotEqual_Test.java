...
public class Doubles_assertNotEqual_Test {
  ...
  public void should_fail_if_actual_is_equal_to_expected() {
    try {
      doubles.assertNotEqual(description, 8d, 8d);
    } catch (AssertionError e) {
      verify(failures).failure(description, ShouldNotBeEqual.shouldNotBeEqual(8d, 8d));
      return;
    }
  ...
  public void should_pass_if_actual_is_not_equal_to_expected() {
    doubles.assertNotEqual(description, 8d, 6d);
  }
}
