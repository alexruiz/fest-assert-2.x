...
public class Comparables_assertLessThan_with_mocks_Test {
  ...
  public Comparables_assertLessThan_with_mocks_Test(String actual, String other) {
    this.actual = actual;
    this.other = other;
  }
  ...
  public void should_fail_if_actual_is_not_less_than_other() {
    ...
    try {
      ...
      String message = "[Testing] expected:<" + quote(actual) + "> to be less than:<" + quote(other) + ">";
