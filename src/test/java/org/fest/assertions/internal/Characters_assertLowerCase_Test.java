 ...
 * @author Alex
 */
public class Characters_assertLowerCase_Test {
  ...
  public void should_fail_if_actual_is_uppercase() {
    try {
      characters.assertLowerCase(description, 'A');
    } catch (AssertionError e) {
      verify(failures).failure(description, ShouldBeLowerCase.shouldBeLowerCase('A'));
      return;
    }
