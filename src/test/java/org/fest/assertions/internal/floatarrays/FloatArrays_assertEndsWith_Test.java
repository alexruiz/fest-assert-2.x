...
public class FloatArrays_assertEndsWith_Test extends FloatArraysBaseTest {
  ...
  public void should_fail_if_actual_is_null() {
    ...
    arrays.assertEndsWith(someInfo(), null, newArray(8f));
  }
  ...
  public void should_pass_if_actual_ends_with_sequence() {
    arrays.assertEndsWith(someInfo(), actual, newArray(8f, 10f, 12f));
  }

  @Test
  public void should_pass_if_actual_and_sequence_are_equal() {
    arrays.assertEndsWith(someInfo(), actual, newArray(6f, 8f, 10f, 12f));
  }
  ...
  public void should_fail_if_actual_is_null_whatever_custom_comparison_strategy_is() {
    thrown.expectAssertionError(actualIsNull());
    arraysWithCustomComparisonStrategy.assertEndsWith(someInfo(), null, newArray(-8f));
  }
  ...
  public void should_pass_if_actual_ends_with_sequence_according_to_custom_comparison_strategy() {
    arraysWithCustomComparisonStrategy.assertEndsWith(someInfo(), actual, newArray(-8f, 10f, 12f));
  }

  @Test
  public void should_pass_if_actual_and_sequence_are_equal_according_to_custom_comparison_strategy() {
    arraysWithCustomComparisonStrategy.assertEndsWith(someInfo(), actual, newArray(6f, -8f, 10f, 12f));
  }
}
