...
public class Doubles_assertLessThan_Test {
  ...
  public void should_fail_if_actual_is_greater_than_other() {
    try {
      doubles.assertLessThan(description, 8d, 6d);
    } catch (AssertionError e) {
      verify(failures).failure(description, shouldBeLessThan(8d, 6d));
      return;
    }
  ...
  public void should_fail_if_actual_is_equal_to_other() {
    try {
      doubles.assertLessThan(description, 6d, 6d);
    } catch (AssertionError e) {
      verify(failures).failure(description, shouldBeLessThan(6d, 6d));
      return;
    }
    expectedAssertionErrorNotThrown();
  }
  ...
  public void should_pass_if_actual_is_less_than_other() {
    doubles.assertLessThan(description, 6d, 8d);
  }
}
