...
public class ByteArrays_assertIsSorted_Test {
  ...
  private byte[] actual = { 1, 2, 3, 4, 5, 6 };
  ...
  public void should_pass_if_actual_is_empty() {
    arrays.assertIsSorted(description, new byte[0]);
  }

  @Test
  public void should_pass_if_actual_is_sorted_with_same_elements() {
    actual = new byte[] { 1, 2, 3, 4, 5, 5, 6, 6 };
    arrays.assertIsSorted(description, actual);
  }
