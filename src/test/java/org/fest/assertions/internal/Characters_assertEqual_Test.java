 ...
 * @author Alex
 */
public class Characters_assertEqual_Test {
  ...
  public void should_fail_if_actual_is_not_equal_to_expected() {
    try {
      characters.assertEqual(description, 'a', 'b');
    } catch (AssertionError e) {
      verify(failures).failure(description, ShouldBeEqual.shouldBeEqual('a', 'b'));
      return;
    }
  ...
  public void should_pass_if_actual_is_equal_to_expected() {
    characters.assertEqual(description, 'a', 'a');
  }
}
