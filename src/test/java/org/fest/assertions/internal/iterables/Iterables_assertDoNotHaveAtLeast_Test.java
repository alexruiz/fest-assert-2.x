...
/**
 * Tests for <code>{@link Iterables#assertDoNotHaveAtLeast(AssertionInfo, Iterable, Matcher, int)}</code> .
 * 
 * @author Nicolas François
 * @author Mikhail Mazursky
 * @author Joel Costigliola
 */
public class Iterables_assertDoNotHaveAtLeast_Test extends IterablesWithConditionsBaseTest {
