...
/**
 * Tests for <code>{@link Iterables#assertAreNotAtMost(AssertionInfo, Iterable, Matcher, int)}</code> .
 * 
 * @author Nicolas François
 * @author Mikhail Mazursky
 * @author Joel Costigliola
 */
public class Iterables_assertAreNotAtMost_Test extends IterablesWithConditionsBaseTest {
