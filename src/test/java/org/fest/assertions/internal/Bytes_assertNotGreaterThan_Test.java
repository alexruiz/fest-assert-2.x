...
/**
 * Tests for <code>{@link Bytes#assertNotGreaterThan(Description, Byte, byte)}</code>.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class Bytes_assertNotGreaterThan_Test {
  ...
  public void should_fail_if_actual_is_greater_than_expected() {
    ...
    try {
      ...
      verify(failures).failure(description, shouldNotBeGreaterThan(actual, expected));
      return;
    }
