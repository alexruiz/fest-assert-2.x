...
public class Collections_assertEndsWith_Test {
  ...
  public void should_throw_error_if_sequence_is_null() {
    ...
    collections.assertEndsWith(description, actual, null);
  }

  @Test
  public void should_throw_error_if_sequence_is_empty() {
    thrown.expect(IllegalArgumentException.class, valuesToLookForIsEmpty());
    collections.assertEndsWith(description, actual, new Object[] {});
  }

  @Test
  public void should_fail_if_actual_is_null() {
    thrown.expect(AssertionError.class, actualIsNull());
    collections.assertEndsWith(description, null, Arrays.array("Yoda"));
  }
  ...
  public void should_pass_if_actual_ends_with_sequence() {
    collections.assertEndsWith(description, actual, array("Yoda", "Leia"));
  }

  @Test
  public void should_pass_if_actual_and_sequence_are_equal() {
    collections.assertEndsWith(description, actual, array("Luke", "Yoda", "Leia"));
  }
}
