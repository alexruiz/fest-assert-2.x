 ...
 */
public class ShortArrays_assertDoesNotContain_Test extends AbstractTest_for_ShortArrays {
  ...
  public void should_fail_if_actual_contains_given_values_according_to_custom_comparison_strategy() {
    ...
    try {
      ...
      verify(failures).failure(info,
          shouldNotContain(actual, expected, set((short) 6, (short) -8), absValueComparisonStrategy));
      return;
    }
    failBecauseExpectedAssertionErrorWasNotThrown();
  }
