...
public class ShortArrays_assertDoesNotContain_Test {
  ...
  public void should_fail_if_actual_is_null() {
    ...
    arrays.assertDoesNotContain(description, null, new short[2]);
  }

  @Test
  public void should_fail_if_other_is_null() {
    thrown.expect(NullPointerException.class, "The array of values to look for should not be null");
    arrays.assertDoesNotContain(description, new short[6], null);
  }
  ...
  public void should_fail_if_other_is_empty() {
    ...
    arrays.assertDoesNotContain(description, new short[1], new short[0]);
  }
  ...
  public void should_fail_if_actual_contains_other() {
    ...
    short[] other = { 6, 8 };
    Set<Short> found = newLinkedHashSet();
    found.add((short) 6);
    found.add((short) 8);
    try {
  ...
  public void should_pass_if_actual_is_empty() {
    arrays.assertDoesNotContain(description, new short[0], new short[1]);
  }
}
