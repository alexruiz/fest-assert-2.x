...
/**
 * Tests for <code>{@link CharArrays#assertEndsWith(Description, char[], char[])}</code>.
 *
 * @author Alex Ruiz
...
public class CharArrays_assertEndsWith_Test {
  ...
  public void should_fail_if_actual_is_null() {
    ...
    arrays.assertEndsWith(description, null, newArray('a'));
  }
  ...
  public void should_pass_if_actual_ends_with_sequence() {
    arrays.assertEndsWith(description, actual, newArray('b', 'c', 'd'));
  }

  @Test
  public void should_pass_if_actual_and_sequence_are_equal() {
    arrays.assertEndsWith(description, actual, newArray('a', 'b', 'c', 'd'));
  }
}
