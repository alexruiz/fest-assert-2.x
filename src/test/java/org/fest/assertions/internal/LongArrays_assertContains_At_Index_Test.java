 ...
 * @author Yvonne Wang
 */
public class LongArrays_assertContains_At_Index_Test {
  ...
  public void should_fail_if_actual_is_empty() {
    try {
      arrays.assertContains(description, new long[0], value, Index.atIndex(0));
  ...
  public void should_fail_if_index_is_negative() {
    ...
    arrays.assertContains(description, new long[1], 0, Index.atIndex(-1));
  }
