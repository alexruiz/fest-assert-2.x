 ...
 */
public class ByteArrays_assertDoesNotContain_Test extends AbstractTest_for_ByteArrays {
  ...
  public void should_fail_if_actual_contains_given_values_according_to_custom_comparison_strategy() {
    ...
    try {
      ...
      verify(failures).failure(info,
          shouldNotContain(actual, expected, set((byte) 6, (byte) -8), absValueComparisonStrategy));
      return;
    }
    failBecauseExpectedAssertionErrorWasNotThrown();
  }
