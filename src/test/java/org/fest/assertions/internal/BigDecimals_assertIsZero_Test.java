...
/**
 * Tests for <code>{@link BigDecimals#assertIsZero(Description, BigDecimal)}</code>.
 *
 * @author Yvonne Wang
...
public class BigDecimals_assertIsZero_Test {
  ...
  public void should_pass_if_actual_is_zero() {
    bigDecimals.assertIsZero(description, BigDecimal.ZERO);
  }

  @Test
  public void should_fail_if_actual_is_not_zero() {
    thrown.expect(AssertionError.class, "[testing] expected:<[0]> but was:<[1]>");
    bigDecimals.assertIsZero(description, BigDecimal.ONE);
  }
}
