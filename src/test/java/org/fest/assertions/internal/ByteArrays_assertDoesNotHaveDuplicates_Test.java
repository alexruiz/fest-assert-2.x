 ...
 */
public class ByteArrays_assertDoesNotHaveDuplicates_Test extends AbstractTest_for_ByteArrays {
  ...
  public void should_fail_if_actual_contains_duplicates_according_to_custom_comparison_strategy() {
    ...
    try {
      ...
      verify(failures).failure(info,
          shouldNotHaveDuplicates(actual, set((byte) 6, (byte) -8), absValueComparisonStrategy));
      return;
    }
    failBecauseExpectedAssertionErrorWasNotThrown();
  }
