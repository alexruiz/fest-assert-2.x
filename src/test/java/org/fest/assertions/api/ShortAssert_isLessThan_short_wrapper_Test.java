 ...
 * @author Yvonne Wang
 */
public class ShortAssert_isLessThan_short_wrapper_Test {
  @Rule
  public ExpectedException thrown = none();
  private ShortAssert assertions;
  private Short actual = new Short((short) 6);
  private Short expected = new Short((short) 8);
  ...
  public void should_return_this() {
    ShortAssert returned = assertions.isLessThan(expected);
  ...
  public void should_fail_if_actual_is_less_than_expected() {
    thrown.expect(AssertionError.class);
    assertions.isLessThan(new Short((short) 18));
  }
