...
/**
 * Tests for <code>{@link org.fest.assertions.api.ShortArrayAssert#isSorted()}</code>.
 * 
 * @author Joel Costigliola
 */
public class ShortArrayAssert_isSorted_Test extends ShortArrayAssertBaseTest {
