...
/**
 * Tests for <code>{@link org.fest.assertions.api.ShortArrayAssert#startsWith(short...)}</code>.
 * 
 * @author Alex Ruiz
 */
public class ShortArrayAssert_startsWith_Test extends ShortArrayAssertBaseTest {
