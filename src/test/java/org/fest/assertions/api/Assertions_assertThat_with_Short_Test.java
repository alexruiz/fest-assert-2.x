...
public class Assertions_assertThat_with_Short_Test {
  ...
  public void should_pass_actual() {
    ...
    Assertions.assertThat(3).overridingErrorMessage("something is wrong").isEqualTo(4).isLessThan(3);
    Assertions.assertThat(3).isEqualTo(4, overridingErrorMessage("something is wrong"));
    Assertions.assertThat(4).isEqualTo(3, usingComparator(blah));
  }
}
