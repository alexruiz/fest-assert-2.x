...
/**
 * Tests for {@link CharacterAssert#isNotLessThan(char)}.
 *
 * @author Yvonne Wang
 */
public class CharacterAssert_isNotLessThan_char_Test {
  @Rule
  public ExpectedException thrown = none();
  private CharacterAssert assertions;
  private Character actual = 'b';
