...
/**
 * Tests for <code>{@link org.fest.assertions.api.ListAssert#usingComparator(java.util.Comparator)}</code> and
 * <code>{@link org.fest.assertions.api.ListAssert#usingDefaultComparator()}</code>.
 * 
