...
public class CharArrayAssert_isSortedAccordingToComparator_Test {
  ...
  public void should_verify_that_assertIsSorted_is_called() {
    CharArrays arrays = mock(CharArrays.class);
    CharArrayAssert assertions = new CharArrayAssert(emptyArray());
  ...
  public void should_return_this() {
    CharArrayAssert objectArrayAssert = new CharArrayAssert(new char[] {'a', 'b'});
