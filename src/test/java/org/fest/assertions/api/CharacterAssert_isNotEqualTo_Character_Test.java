...
/**
 * Tests for {@link CharacterAssert#isNotEqualTo(Character)}.
 *
 * @author Yvonne Wang
 */
public class CharacterAssert_isNotEqualTo_Character_Test {
  @Rule
  public ExpectedException thrown = none();
  private CharacterAssert assertions;
  private final Character actual = new Character('a');
  private final Character expected = new Character('b');
