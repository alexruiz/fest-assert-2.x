...
public class MapAssert_doesNotContainValue_Test {
  ...
  @Test public void should_verify_that_actual_contains_given_values() {
    assertions.doesNotContainValue("value1");
    verify(maps).assertDoesNotContainValue(assertions.info, assertions.actual, "value1");
  }

  @Test public void should_return_this() {
    MapAssert<Object, Object> returned = assertions.doesNotContainValue("value1");
