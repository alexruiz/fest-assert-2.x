 ...
 * @author Alex Ruiz
 */
public class BooleanArrayAssert_containsSequence_Test extends BooleanArrayAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    verify(arrays).assertContainsSequence(getInfo(assertions), getActual(assertions), newArray(true, false));
  }
}
