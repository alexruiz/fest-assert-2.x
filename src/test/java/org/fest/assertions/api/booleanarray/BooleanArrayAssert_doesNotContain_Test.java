 ...
 * @author Alex Ruiz
 */
public class BooleanArrayAssert_doesNotContain_Test extends BooleanArrayAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    verify(arrays).assertDoesNotContain(getInfo(assertions), getActual(assertions), newArray(true, false));
  }
}
