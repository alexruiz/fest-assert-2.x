...
/**
 * Tests for {@link FloatAssert#isNotEqualTo(Comparable)}.
 *
 * @author Yvonne Wang
 */
public class FloatAssert_isNotEqualTo_float_wrapper_Test {
  @Rule
  ...
  public void should_return_this() {
    FloatAssert returned = assertions.isNotEqualTo(expected);
