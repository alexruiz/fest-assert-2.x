...
/**
 * Tests for {@link IntegerAssert#isNotLessThan(Integer)}.
 *
 * @author Yvonne Wang
 */
public class IntegerAssert_isNotLessThan_Integer_Test {
  ...
  private final Integer actual = 8;
  private final Integer expected = 6;
  ...
  public void should_return_this() {
    IntegerAssert returned = assertions.isNotLessThan(expected);
