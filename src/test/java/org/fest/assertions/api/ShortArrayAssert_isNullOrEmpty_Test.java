...
/**
 * Tests for {@link ShortArrayAssert#isNullOrEmpty()}.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class ShortArrayAssert_isNullOrEmpty_Test {
  ...
  private short[] actual = new short[0];
  ...
  public void should_return_this_if_actual_is_empty() {
    ShortArrayAssert returned = assertions.isNullOrEmpty();
  ...
  public void should_fail_if_actual_is_not_null_and_not_empty() {
    ...
    assertions = new ShortArrayAssert(new short[1]);
    assertions.isNullOrEmpty();
  }
}
