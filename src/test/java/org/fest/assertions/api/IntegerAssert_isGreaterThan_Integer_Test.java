...
/**
 * Tests for {@link IntegerAssert#isGreaterThan(Integer)}.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class IntegerAssert_isGreaterThan_Integer_Test {
  @Rule
  ...
  public void should_return_this() {
    IntegerAssert returned = assertions.isGreaterThan(expected);
  ...
  public void should_fail_if_actual_is_less_than_expected() {
    thrown.expect(AssertionError.class);
    assertions.isGreaterThan(new Integer(10));
  }
