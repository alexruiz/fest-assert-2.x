...
/**
 * Tests for {@link CharacterAssert#isNotGreaterThan(char)}.
 *
 * @author Yvonne Wang
 */
public class CharacterAssert_isNotGreaterThan_char_Test {
  @Rule
  public ExpectedException thrown = none();
  private CharacterAssert assertions;
  private Character actual = new Character('b');
  private char expected = 'c';
