...
/**
 * Tests for {@link DateAssert#isNotEqualTo(java.util.Date)} and {@link DateAssert#isNotEqualTo(String)}.
 * 
...
public class DateAssert_isNotEqualTo_Test extends AbstractDateAssertWithDateArg_Test {
  ...
  protected void verifyAssertionInvocation(Date date) {
    verify(objects).assertNotEqualTo(getInfo(assertions), getActual(assertions), date);
  }
