...
/**
 * Tests for {@link CharacterAssert#isNotLessThan(Character)}.
 *
 * @author Yvonne Wang
 */
public class CharacterAssert_isNotLessThan_Character_Test {
  @Rule
  public ExpectedException thrown = none();
  private CharacterAssert assertions;
  private final Character actual = new Character('b');
  private final Character expected = new Character('a');
  ...
  public void should_return_this() {
    CharacterAssert returned = assertions.isNotLessThan(expected);
  ...
  public void should_fail_if_actual_is_less_than_expected() {
    thrown.expect(AssertionError.class);
    assertions.isNotLessThan(new Character('c'));
  }
}
