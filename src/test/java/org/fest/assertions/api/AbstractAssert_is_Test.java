...
/**
 * Tests for {@link AbstractAssert#is(Matcher)}.
 *
 * @author Alex Ruiz
 */
public class AbstractAssert_is_Test {
  ...
  public void should_verify_that_actual_satisfies_Matcher() {
    assertions.is(matcher);
    verify(matchers).assertIs(assertions.description, assertions.actual, matcher);
  }

  @Test
  public void should_return_this() {
    ConcreteAssert returned = assertions.is(matcher);
