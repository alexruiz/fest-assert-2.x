...
public class AbstractComparableAssert_isLessThan_Test {
  ...
  @Test public void should_verify_that_actual_is_less_than_other() {
    assertions.isLessThan(8);
    verify(comparables).assertLessThan(assertions.description, assertions.actual, 8);
  }

  @Test public void should_return_this() {
    ConcreteComparableAssert returned = assertions.isLessThan(8);
