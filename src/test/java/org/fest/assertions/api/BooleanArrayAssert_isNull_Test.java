...
/**
 * Tests for {@link BooleanArrayAssert#isNull()}.
 *
 * @author Yvonne Wang
 */
public class BooleanArrayAssert_isNull_Test {
  ...
  public void should_return_this() {
    BooleanArrayAssert returned = new BooleanArrayAssert(actual);
