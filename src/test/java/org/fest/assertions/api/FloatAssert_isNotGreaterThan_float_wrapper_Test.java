...
/**
 * Tests for {@link FloatAssert#isNotGreaterThan(Comparable)}.
 *
 * @author Yvonne Wang
 */
public class FloatAssert_isNotGreaterThan_float_wrapper_Test {
  @Rule
  ...
  public void should_fail_if_actual_is_greater_than_expected() {
    thrown.expect(AssertionError.class);
    assertions.isNotGreaterThan(new Float(2f));
  }
