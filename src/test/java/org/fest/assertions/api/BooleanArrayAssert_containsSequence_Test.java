...
/**
 * Tests for {@link BooleanArrayAssert#containsSequence(boolean...)}.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class BooleanArrayAssert_containsSequence_Test {
  ...
  private final boolean[] sequence = {true, false};
  ...
  public void should_return_this() {
    BooleanArrayAssert returned = assertions.containsSequence(sequence);
