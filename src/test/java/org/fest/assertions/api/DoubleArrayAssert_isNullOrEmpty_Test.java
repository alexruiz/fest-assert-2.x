...
/**
 * Tests for {@link DoubleArrayAssert#isNullOrEmpty()}.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class DoubleArrayAssert_isNullOrEmpty_Test {
  ...
  private double[] actual = new double[0];
  ...
  public void should_return_this_if_actual_is_empty() {
    DoubleArrayAssert returned = assertions.isNullOrEmpty();
  ...
  public void should_fail_if_actual_is_not_null_and_not_empty() {
    ...
    assertions = new DoubleArrayAssert(new double[1]);
    assertions.isNullOrEmpty();
  }
}
