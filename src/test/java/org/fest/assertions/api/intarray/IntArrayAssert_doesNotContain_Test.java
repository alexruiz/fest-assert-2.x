...
/**
 * Tests for <code>{@link org.fest.assertions.api.IntArrayAssert#doesNotContain(int...)}</code>.
 * 
 * @author Alex Ruiz
 */
public class IntArrayAssert_doesNotContain_Test extends IntArrayAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    verify(arrays).assertDoesNotContain(getInfo(assertions), getActual(assertions), newArray(6, 8));
  }
}
