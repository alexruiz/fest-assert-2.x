...
/**
 * Tests for <code>{@link org.fest.assertions.api.IntArrayAssert#containsSequence(int...)}</code>.
 * 
 * @author Alex Ruiz
 */
public class IntArrayAssert_containsSequence_Test extends IntArrayAssertBaseTest {
