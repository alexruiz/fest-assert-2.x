...
/**
 * Tests for <code>{@link org.fest.assertions.api.IntArrayAssert#containsOnly(int...)}</code>.
 * 
 * @author Alex Ruiz
 */
public class IntArrayAssert_containsOnly_Test extends IntArrayAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    verify(arrays).assertContainsOnly(getInfo(assertions), getActual(assertions), newArray(6, 8));
  }
}
