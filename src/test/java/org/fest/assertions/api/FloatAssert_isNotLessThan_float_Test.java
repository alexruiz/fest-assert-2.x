...
/**
 * Tests for {@link FloatAssert#isNotLessThan(float)}.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class FloatAssert_isNotLessThan_float_Test {
  @Rule
  ...
  public void should_return_this() {
    FloatAssert returned = assertions.isNotLessThan(expected);
