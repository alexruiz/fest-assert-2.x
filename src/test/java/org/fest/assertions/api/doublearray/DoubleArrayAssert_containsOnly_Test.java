...
/**
 * Tests for <code>{@link org.fest.assertions.api.DoubleArrayAssert#containsOnly(double...)}</code>.
 * 
 * @author Alex Ruiz
 */
public class DoubleArrayAssert_containsOnly_Test extends DoubleArrayAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    verify(arrays).assertContainsOnly(getInfo(assertions), getActual(assertions), newArray(6d, 8d));
  }
}
