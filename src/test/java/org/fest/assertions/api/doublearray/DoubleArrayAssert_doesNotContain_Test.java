...
/**
 * Tests for <code>{@link org.fest.assertions.api.DoubleArrayAssert#doesNotContain(double...)}</code>.
 * 
 * @author Alex Ruiz
 */
public class DoubleArrayAssert_doesNotContain_Test extends DoubleArrayAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    verify(arrays).assertDoesNotContain(getInfo(assertions), getActual(assertions), newArray(6d, 8d));
  }
}
