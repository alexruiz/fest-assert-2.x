...
/**
 * Tests for {@link MapAssert#contains(MapEntry...)}.
 *
 * @author Alex Ruiz
...
public class MapAssert_contains_Test {
  ...
  @Test
  public void should_throw_error_if_entries_is_empty() {
    thrown.expect(AssertionError.class);
  ...
  public void should_fail_if_actual_does_not_contain_given_entries() {
    thrown.expect(AssertionError.class);
    assertions.contains(MapEntry.entry("two", "apple"));
  }
}
