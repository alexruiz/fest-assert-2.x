...
/**
 * Tests for {@link AbstractAssert#doesNotHave(Matcher)}.
 *
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class AbstractAssert_doesNotHave_Test {
  ...
  public void should_verify_that_actual_does_not_satisfy_Matcher() {
    assertions.doesNotHave(matcher);
    verify(matchers).assertDoesNotHave(assertions.description, assertions.actual, matcher);
  }

  @Test
  public void should_return_this() {
    ConcreteAssert returned = assertions.doesNotHave(matcher);
