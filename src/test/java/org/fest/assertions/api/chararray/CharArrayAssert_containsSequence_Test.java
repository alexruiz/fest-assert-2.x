...
/**
 * Tests for <code>{@link org.fest.assertions.api.CharArrayAssert#containsSequence(char...)}</code>.
 * 
 * @author Alex Ruiz
 */
public class CharArrayAssert_containsSequence_Test extends CharArrayAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    verify(arrays).assertContainsSequence(getInfo(assertions), getActual(assertions), newArray('a', 'b'));
  }
}
