...
/**
 * Tests for <code>{@link org.fest.assertions.api.CharArrayAssert#doesNotHaveDuplicates()}</code>.
 * 
 * @author Alex Ruiz
 */
public class CharArrayAssert_doesNotHaveDuplicates_Test extends CharArrayAssertBaseTest {
