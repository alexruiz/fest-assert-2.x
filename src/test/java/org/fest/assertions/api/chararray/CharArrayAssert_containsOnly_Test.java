...
/**
 * Tests for <code>{@link org.fest.assertions.api.CharArrayAssert#containsOnly(char...)}</code>.
 * 
 * @author Alex Ruiz
 */
public class CharArrayAssert_containsOnly_Test extends CharArrayAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    verify(arrays).assertContainsOnly(getInfo(assertions), getActual(assertions), newArray('a', 'b'));
  }
}
