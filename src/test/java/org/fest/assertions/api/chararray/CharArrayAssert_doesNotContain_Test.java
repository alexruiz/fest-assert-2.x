...
/**
 * Tests for <code>{@link org.fest.assertions.api.CharArrayAssert#doesNotContain(char...)}</code>.
 * 
 * @author Alex Ruiz
 */
public class CharArrayAssert_doesNotContain_Test extends CharArrayAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    verify(arrays).assertDoesNotContain(getInfo(assertions), getActual(assertions), newArray('a', 'b'));
  }
}
