...
/**
 * Tests for <code>{@link org.fest.assertions.api.CharArrayAssert#endsWith(char...)}</code>.
 * 
 * @author Alex Ruiz
 */
public class CharArrayAssert_endsWith_Test extends CharArrayAssertBaseTest {
