...
/**
 * Tests for <code>{@link org.fest.assertions.api.CharArrayAssert#startsWith(char...)}</code>.
 * 
 * @author Alex Ruiz
 */
public class CharArrayAssert_startsWith_Test extends CharArrayAssertBaseTest {
