 ...
 * @author Alex Ruiz
 */
public class LongAssert_isGreaterThanOrEqualTo_long_Test extends LongAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    verify(longs).assertNotLessThan(getInfo(assertions), getActual(assertions), 6L);
  }
}
