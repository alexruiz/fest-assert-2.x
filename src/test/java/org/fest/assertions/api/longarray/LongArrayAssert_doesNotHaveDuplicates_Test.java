...
/**
 * Tests for <code>{@link org.fest.assertions.api.LongArrayAssert#doesNotHaveDuplicates()}</code>.
 * 
 * @author Alex Ruiz
 */
public class LongArrayAssert_doesNotHaveDuplicates_Test extends LongArrayAssertBaseTest {
