...
/**
 * Tests for <code>{@link org.fest.assertions.api.LongArrayAssert#endsWith(long...)}</code>.
 * 
 * @author Alex Ruiz
 */
public class LongArrayAssert_endsWith_Test extends LongArrayAssertBaseTest {
