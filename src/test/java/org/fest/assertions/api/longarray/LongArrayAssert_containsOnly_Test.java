...
/**
 * Tests for <code>{@link org.fest.assertions.api.LongArrayAssert#containsOnly(long...)}</code>.
 * 
 * @author Alex Ruiz
 */
public class LongArrayAssert_containsOnly_Test extends LongArrayAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    verify(arrays).assertContainsOnly(getInfo(assertions), getActual(assertions), newArray(6L, 8L));
  }
}
