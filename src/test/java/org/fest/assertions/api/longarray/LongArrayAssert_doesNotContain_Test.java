...
/**
 * Tests for <code>{@link org.fest.assertions.api.LongArrayAssert#doesNotContain(long...)}</code>.
 * 
 * @author Alex Ruiz
 */
public class LongArrayAssert_doesNotContain_Test extends LongArrayAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    verify(arrays).assertDoesNotContain(getInfo(assertions), getActual(assertions), newArray(6L, 8L));
  }
}
