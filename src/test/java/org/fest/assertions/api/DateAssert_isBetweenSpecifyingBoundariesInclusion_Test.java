...
/**
 * Tests for {@link DateAssert#isBetween(Date, Date, boolean, boolean)} and {@link DateAssert#isBetween(String, String, boolean, boolean)}.
 *
...
public class DateAssert_isBetweenSpecifyingBoundariesInclusion_Test extends AbstractDateAssertWithDateArg_Test {
  ...
  protected void verifyAssertionInvocation(Date date) {
    verify(dates).assertIsBetween(assertions.info, assertions.actual, date, date, inclusiveStart, inclusiveEnd);
  }
