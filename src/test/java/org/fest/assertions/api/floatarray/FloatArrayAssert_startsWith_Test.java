...
/**
 * Tests for <code>{@link org.fest.assertions.api.FloatArrayAssert#startsWith(float...)}</code>.
 * 
 * @author Alex Ruiz
 */
public class FloatArrayAssert_startsWith_Test extends FloatArrayAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    verify(arrays).assertEndsWith(getInfo(assertions), getActual(assertions), newArray(6f, 8f));
  }
}
