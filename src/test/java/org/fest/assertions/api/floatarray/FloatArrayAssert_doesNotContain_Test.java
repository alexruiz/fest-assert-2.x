...
/**
 * Tests for <code>{@link org.fest.assertions.api.FloatArrayAssert#doesNotContain(float...)}</code>.
 * 
 * @author Alex Ruiz
 */
public class FloatArrayAssert_doesNotContain_Test extends FloatArrayAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    verify(arrays).assertDoesNotContain(getInfo(assertions), getActual(assertions), newArray(6f, 8f));
  }
}
