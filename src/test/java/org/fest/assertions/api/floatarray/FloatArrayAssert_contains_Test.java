...
/**
 * Tests for <code>{@link org.fest.assertions.api.FloatArrayAssert#contains(float...)}</code>.
 * 
 * @author Alex Ruiz
 */
public class FloatArrayAssert_contains_Test extends FloatArrayAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    verify(arrays).assertContains(getInfo(assertions), getActual(assertions), newArray(6f, 8f));
  }
}
