...
/**
 * Tests for <code>{@link org.fest.assertions.api.FloatArrayAssert#containsSequence(float...)}</code>.
 * 
 * @author Alex Ruiz
 */
public class FloatArrayAssert_containsSequence_Test extends FloatArrayAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    verify(arrays).assertContainsSequence(getInfo(assertions), getActual(assertions), newArray(6f, 8f));
  }
}
