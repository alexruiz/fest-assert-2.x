...
/**
 * Tests for <code>{@link org.fest.assertions.api.FloatArrayAssert#containsOnly(float...)}</code>.
 * 
 * @author Alex Ruiz
 */
public class FloatArrayAssert_containsOnly_Test extends FloatArrayAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    verify(arrays).assertContainsOnly(getInfo(assertions), getActual(assertions), newArray(6f, 8f));
  }
}
