...
public class MapAssert_doesNotContainKey_Test {
  ...
  @Test public void should_verify_that_actual_contains_given_values() {
    assertions.doesNotContainKey("key1");
    verify(maps).assertDoesNotContainKey(assertions.info, assertions.actual, "key1");
  }

  @Test public void should_return_this() {
    MapAssert<Object, Object> returned = assertions.doesNotContainKey("key1");
