...
/**
 * Tests for {@link ShortArrayAssert#startsWith(short...)}.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class ShortArrayAssert_startsWith_Test {
  ...
  @Test
  public void should_throw_error_if_actual_starts_with_given_sequence_multiple_times() {
    thrown.expect(AssertionError.class);
    assertions.startsWith((short) 6, (short) 6, (short) 8, (short) 10, (short) 10);
  }
  ...
  public void should_fail_if_actual_does_not_start_with_given_sequence() {
    thrown.expect(AssertionError.class);
    assertions.startsWith((short) 2, (short) 4);
  }
}
