...
/**
 * Tests for <code>{@link org.fest.assertions.api.ObjectArrayAssert#doNotHaveAtLeas(org.fest.assertions.core.Matcher, int)}</code>.
 * 
 * @author Nicolas François
 * @author Mikhail Mazursky
 */
public class ObjectArrayAssert_doNotHaveAtLeast_Test extends ObjectArrayAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    verify(arrays).assertDoNotHaveAtLeast(getInfo(assertions), getActual(assertions), 2, condition);
  }
}
