...
/**
 * Tests for <code>{@link org.fest.assertions.api.ObjectArrayAssert#usingElementComparator(java.util.Comparator)}</code>.
 * 
...
public class ObjectArrayAssert_usingElementComparator_Test extends ObjectArrayAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    ...
    assertSame(getArrays(assertions).getComparator(), elementComparator);
  }
}
