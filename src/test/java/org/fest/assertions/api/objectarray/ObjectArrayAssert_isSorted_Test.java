...
/**
 * Tests for <code>{@link org.fest.assertions.api.ObjectArrayAssert#isSorted()}</code>.
 * 
 * @author Joel Costigliola
 * @author Mikhail Mazursky
 */
public class ObjectArrayAssert_isSorted_Test extends ObjectArrayAssertBaseTest {
