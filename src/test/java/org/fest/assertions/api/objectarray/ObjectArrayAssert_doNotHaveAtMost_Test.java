...
/**
 * Tests for <code>{@link org.fest.assertions.api.ObjectArrayAssert#doNotHaveAtMost(org.fest.assertions.core.Matcher, int)}</code>.
 * 
...
public class ObjectArrayAssert_doNotHaveAtMost_Test extends ObjectArrayAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    verify(arrays).assertDoNotHaveAtMost(getInfo(assertions), getActual(assertions), 2, condition);
  }
}
