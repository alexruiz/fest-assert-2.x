...
/**
 * Tests for <code>{@link org.fest.assertions.api.ObjectArrayAssert#containsOnly(Object...)}</code>.
 * 
 * @author Alex Ruiz
...
public class ObjectArrayAssert_containsOnly_Test extends ObjectArrayAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    verify(arrays).assertContainsOnly(getInfo(assertions), getActual(assertions), array("Yoda", "Luke"));
  }
}
