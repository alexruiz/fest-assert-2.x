...
/**
 * Tests for <code>{@link org.fest.assertions.api.ObjectArrayAssert#doNotHaveExactly(org.fest.assertions.core.Matcher, int)}</code>.
 * 
 * @author Nicolas François
 * @author Mikhail Mazursky
 */
public class ObjectArrayAssert_doNotHaveExactly_Test extends ObjectArrayAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    verify(arrays).assertDoNotHaveExactly(getInfo(assertions), getActual(assertions), 2, condition);
  }
}
