...
/**
 * Tests for {@link AbstractUnevenComparableAssert#isNotEqualByComparingTo(Comparable)}.
 *
 * @author Yvonne Wang
 */
public class AbstractUnevenComparableAssert_isNotEqualToByComparingTo_Test {
  ...
  public void should_return_this() {
    ConcreteUnevenComparableAssert returned = assertions.isNotEqualByComparingTo(expected);
