...
public class MapAssert_containsValue_Test {
  ...
  @Test public void should_verify_that_actual_contains_given_values() {
    assertions.containsValue("key1");
    verify(maps).assertContainsValue(assertions.info, assertions.actual, "key1");
  }

  @Test public void should_return_this() {
    MapAssert<Object, Object> returned = assertions.containsValue("key1");
