...
/**
 * Tests for <code>{@link AbstractIterableAssert#areNotExactly(org.fest.assertions.core.Matcher, int)}</code>.
 * 
 * @author Nicolas François
 */
public class IterableAssert_areNotExactly_Test extends IterableAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    verify(iterables).assertAreNotExactly(getInfo(assertions), getActual(assertions), 2, condition);
  }
}
