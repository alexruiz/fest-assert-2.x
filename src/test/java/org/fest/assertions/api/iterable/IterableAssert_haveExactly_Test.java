...
/**
 * Tests for <code>{@link AbstractIterableAssert#haveExactly(org.fest.assertions.core.Matcher, int)}</code>.
 * 
 * @author Nicolas François
 */
public class IterableAssert_haveExactly_Test extends IterableAssertBaseTest {
