 ...
 * @author Alex Ruiz
 */
public class DoubleAssert_isNotEqualTo_double_Test extends DoubleAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    verify(doubles).assertNotEqualTo(getInfo(assertions), getActual(assertions), 8d);
  }
}
