...
/**
 * Tests for {@link SetAssert#containsOnly(Collection[])}.
 *
 * @author Yvonne Wang
 */
public class SetAssert_containsOnly_Test {
  @Rule
  public ExpectedException thrown = none();
  private Set<String> actual = Sets.newLinkedHashSet("one", "two", "three");
  private Set<String> expected = Sets.newHashSet();
  ...
  @Test
  public void should_pass_if_actual_containsOnly_expected_in_different_order() {
    expected.add("one");
    expected.add("three");
    expected.add("two");
    assertions.containsOnly(expected);
