 ...
 * @author Yvonne Wang
 */
public class SetAssert_isEqualTo_Test {
  @Rule
  public ExpectedException thrown = none();
  private Set<String> actual = Sets.newLinkedHashSet("one", "two", "three");
  private Set<String> expected = Sets.newLinkedHashSet("two", "three", "one");
  ...
  @Test
  public void should_pass_if_actual_is_equal_to_expected_in_different_order(){
    assertions.isEqualTo(expected);
  }
}
