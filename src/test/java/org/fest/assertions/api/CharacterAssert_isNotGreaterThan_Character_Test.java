...
/**
 * Tests for {@link CharacterAssert#isNotGreaterThan(Character)}.
 *
 * @author Yvonne Wang
 */
public class CharacterAssert_isNotGreaterThan_Character_Test {
  @Rule
  public ExpectedException thrown = none();
  private CharacterAssert assertions;
  private final Character actual = new Character('b');
  private final Character expected = new Character('c');
  ...
  public void should_return_this() {
    CharacterAssert returned = assertions.isNotGreaterThan(expected);
  ...
  public void should_fail_if_actual_is_greater_than_expected() {
    thrown.expect(AssertionError.class);
    assertions.isNotGreaterThan(new Character('a'));
  }
}
