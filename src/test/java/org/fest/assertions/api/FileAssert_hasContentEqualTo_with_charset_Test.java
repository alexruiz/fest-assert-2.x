...
public class FileAssert_hasContentEqualTo_with_charset_Test {
  ...
  public void should_verify_that_content_in_actual_is_equal_to_expected() {
    ...
    verify(files).assertEqualContent(assertions.description, assertions.actual, expected, charset);
  }

  @Test
  public void should_return_this() {
    FileAssert returned = assertions.hasContentEqualTo(mock(File.class), mock(Charset.class));
