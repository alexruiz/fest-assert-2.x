...
public class LongAssert_isLessThan_long_Test {
  ...
  private Long actual = new Long(6l);
  private final long expected = 8l;
  ...
  public void should_return_this() {
    LongAssert returned = assertions.isLessThan(expected);
  ...
  public void should_fail_if_actual_is_less_than_expected() {
    thrown.expect(AssertionError.class);
    assertions.isLessThan(2l);
  }

  @Test
  public void should_fail_if_actual_is_equal_to_expected() {
    thrown.expect(AssertionError.class);
    assertions.isLessThan(actual.longValue());
  }
}
