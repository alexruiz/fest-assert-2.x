 ...
 */
public class ElementsShouldNotHaveAtLeast_create_Test {

  private ErrorMessageFactory factory;

  @Before
  public void setUp() {
    factory = elementsShouldNotHaveAtLeast(newArrayList("Yoda", "Luke", "Leia"), 2, new TestMatcher<String>("Jedi power"));
  }
