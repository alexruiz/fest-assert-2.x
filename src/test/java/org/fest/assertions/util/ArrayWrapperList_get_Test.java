...
public class ArrayWrapperList_get_Test {
  ...
  public void should_throw_error_if_index_is_negative() {
    thrown.expect(IndexOutOfBoundsException.class, "Index should be between 0 and 1 (inclusive,) but was -1");
    list.get(-1);
  }

  @Test
  public void should_throw_error_if_index_is_equal_to_size() {
    thrown.expect(IndexOutOfBoundsException.class, "Index should be between 0 and 1 (inclusive,) but was 2");
    list.get(2);
  }

  @Test
  public void should_throw_error_if_index_is_greater_than_size() {
    thrown.expect(IndexOutOfBoundsException.class, "Index should be between 0 and 1 (inclusive,) but was 6");
    list.get(6);
  }
}
